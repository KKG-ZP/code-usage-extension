...
export const DEFAULT_PRICING = {
    ...
    'mimo-v2-flash': { displayName: 'MiMo V2 Flash', input: 0.7, output: 2.1, cacheRead: 0.07, cacheWrite: 0, currency: 'CNY' },
    'mimo-v2-pro': { displayName: 'MiMo V2 Pro', input: 7, output: 21, cacheRead: 1.4, cacheWrite: 0, currency: 'CNY' },
